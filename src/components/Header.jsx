    ...
    <header className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary">
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between  ">
        <Link to={"/"} className="flex items-center gap-2">
          ...
          <p className="text-headingColor text-xl font-bold">Bio</p>
        </Link>
        <div className="flex items-center gap-8">
          ...
          <div className="relative flex items-center justify-center" onClick={showCart}>
           ...
           {cartItems && cartItems.length > 0 && (
              <div className=" absolute -top-2 -right-2 w-5 h-5 rounded-full bg-cartNumBg flex 
          ...
          <div className="relative ">
            ...
            />
            {
              ...
              right-0 ">
              {user && user.email === "mailtestsite017@gmail.com"
                && (
                  <Link to={'/createItem'}>
            ...
            duration-100 ease-in-out text-textColor text-base"
              ...
              <p className="px-4 py-2 flex items-center gap-3 cursor-pointer hover:bg-slate-100 transition-all
            duration-100 ease-in-out text-textColor text-base"  onClick={logout}>Deconnect<MdLogout /></p>
      ...
      <div className="flex items-center justify-between md:hidden w-full h-full  ">
        ...
        <div className="relative flex items-center justify-center"onClick={showCart}>
            <MdShoppingBasket className="text-textColor
        ...
        <div className="relative ">
            ...
            >
              ...
              <p className="m-2 p-2 rounded-md shadow-md flex items-center justify-center bg-gray-200 gap-3 cursor-pointer hover:bg-gray-300 transition-all
            duration-100 ease-in-out text-textColor text-base"
            onClick={logout}>Deconnect<MdLogout /></p>
